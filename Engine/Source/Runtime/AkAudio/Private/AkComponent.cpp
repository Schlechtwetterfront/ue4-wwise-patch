...
void UAkComponent::PostAkEvent( class UAkAudioEvent * AkEvent )
{
    if ( AkEvent )
    {
...
void UAkComponent::PostAkEventByName( const FString& EventName )
{
...
void UAkComponent::UpdateSpriteTexture()
{
    if (SpriteComponent)
    {
        SpriteComponent->SetSprite(LoadObject<UTexture2D>(NULL, TEXT("/Engine/EditorResources/AudioIcons/S_AkComponent.S_AkComponent")));
    }
}
#endif
